...
public class TestCreateCalander {
	...
	public void test() {
		String now_date = "";
		now_date = JodaTimeDateUtil.Today.getTodayString("yyyyMM") + "01";

		int now_start_day = JodaTimeDateUtil.GetDayOfWeek.getFirstDayOfWeek(now_date);
		int now_last_day = JodaTimeDateUtil.GetDayOfMonth.getLastDayOfMonth(now_date);

		StringBuilder sb = new StringBuilder();
		sb.append(JodaTimeDateUtil.StringFormat.getStringDate(now_date, "yyyy.MM"));
		sb.append("\r\n");
